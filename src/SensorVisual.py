...
# =========================
# =========================
SERIAL_PORT = "COM4"     # Windows: COMx | Linux/Mac: /dev/ttyUSB0
BAUD_RATE = 9600
MAX_SENSOR_VALUE = 1023  # change if needed
...
# SERIAL THREAD
# =========================
pattern = re.compile(r"Sensor\s+(\d+):\s+(\d+)")
...
ax.set_aspect("equal")
ax.set_title("Live Line Sensor Visualization")
ax.set_xlabel("X")
ax.set_ylabel("Y")
ax.grid(True)
